...
console.log(firstArtist,", ", thirdArtist)
...
function getArtistByIndex(array, i) {
    return [artists[i].name, artists[i].id]
...
// let twentiesArtists = []
// let life = parseInt(artists[i].years)
...
console.log(addArtist(20, 'Evan', 1997, 'web design', 'american', 'lorem ipsum' ))
...
for(i = 0; i < artists.length; i++){
  ...
  moreThanOneHundred.push(artists[i].name)
  }
}
